...
download_Data <- function(date_1, date_2){
  Zhudong <- StationAllTable("竹東", date_1, date_2)
  Hutoupi <- StationAllTable_engName("Hutoupi", date_1, date_2)
  JS <- StationAllTable("礁溪", date_1, date_2)
  Beiliao <- StationAllTable("北寮", date_1, date_2)
  FS <- StationAllTable("鳳山", date_1, date_2)
  GS <- StationAllTable("金山", date_1, date_2)
  YMS <- StationAllTable_engName("ZHUZIHU", date_1, date_2)
...
download_Data("2017-10-05", "2017-10-17")

#Zhudong <- StationAllTable("竹東", "2017-10-05", "2017-10-17")
