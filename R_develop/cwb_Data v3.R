...
write.csv(C0D560_Rain_for_day_hr24_all, file="c://Taiwan-CWB-Data/writeCSV/C0D560_竹東.csv")
...
names(C0D560_HUM_for_day_hr24)[2:lengthDatep] <- as.vector(as.factor(date))
C0D560_HUM_for_day_hr24_all <- melt(C0D560_HUM_for_day_hr24, id=c("Hour") ) # 把他們排成一排

write.csv(C0D560_HUM_for_day_hr24_all, file="c://Taiwan-CWB-Data/writeCSV/C0D560_竹東_hum_data_.csv")
...
names(C0D560_tem_for_day_hr24)[2:lengthDatep] <- as.vector(as.factor(date))
C0D560_tem_for_day_hr24_all <- melt(C0D560_tem_for_day_hr24, id=c("Hour") ) # 把他們排成一排

write.csv(C0D560_tem_for_day_hr24_all, file="c://Taiwan-CWB-Data/writeCSV/C0D560_竹東_tem_data_.csv")
...
names(C0D560_press_for_day_hr24)[2:lengthDatep] <- as.vector(as.factor(date))
C0D560_press_for_day_hr24_all <- melt(C0D560_press_for_day_hr24, id=c("Hour") ) # 把他們排成一排

write.csv(C0D560_press_for_day_hr24_all, file="c://Taiwan-CWB-Data/writeCSV/C0D560_竹東_press_data_.csv")
...
names(C0O970_Rain_for_day_hr24)[2:lengthDatep] <- as.vector(as.factor(date))
C0O970_Rain_for_day_hr24_all <- melt(C0O970_Rain_for_day_hr24, id=c("Hour") ) # 把他們排成一排

write.csv(C0O970_Rain_for_day_hr24_all, file="c://Taiwan-CWB-Data/writeCSV/C0D560_虎頭埤_rain_data_.csv")
...
names(C0O970_HUM_for_day_hr24)[2:lengthDatep] <- as.vector(as.factor(date))
C0O970_HUM_for_day_hr24_all <- melt(C0O970_HUM_for_day_hr24, id=c("Hour") ) # 把他們排成一排

write.csv(C0O970_HUM_for_day_hr24_all, file="c://Taiwan-CWB-Data/writeCSV/C0D560_虎頭埤_hum_data_.csv")
...
names(C0O970_tem_for_day_hr24)[2:lengthDatep] <- as.vector(as.factor(date))
C0O970_tem_for_day_hr24_all <- melt(C0O970_tem_for_day_hr24, id=c("Hour") ) # 把他們排成一排

write.csv(C0O970_tem_for_day_hr24_all, file="c://Taiwan-CWB-Data/writeCSV/C0D560_虎頭埤_tem_data_.csv")
...
names(C0O970_press_for_day_hr24)[2:lengthDatep] <- as.vector(as.factor(date))
C0O970_press_for_day_hr24_all <- melt(C0O970_press_for_day_hr24, id=c("Hour") ) # 把他們排成一排

write.csv(C0O970_press_for_day_hr24_all, file="c://Taiwan-CWB-Data/writeCSV/C0D560_虎頭埤_press_.csv")
...
names(C0U600_Rain_for_day_hr24)[2:lengthDatep] <- as.vector(as.factor(date))
C0U600_Rain_for_day_hr24_all <- melt(C0U600_Rain_for_day_hr24, id=c("Hour") ) # 把他們排成一排

write.csv(C0U600_Rain_for_day_hr24_all, file="c://Taiwan-CWB-Data/writeCSV/C0D560_礁溪_rain_data_.csv")
...
names(C0U600_HUM_for_day_hr24)[2:lengthDatep] <- as.vector(as.factor(date))
C0U600_HUM_for_day_hr24_all <- melt(C0U600_HUM_for_day_hr24, id=c("Hour") ) # 把他們排成一排

write.csv(C0U600_HUM_for_day_hr24_all, file="c://Taiwan-CWB-Data/writeCSV/C0D560_礁溪_hum_data_.csv")
...
names(C0U600_tem_for_day_hr24)[2:lengthDatep] <- as.vector(as.factor(date))
C0U600_tem_for_day_hr24_all <- melt(C0U600_tem_for_day_hr24, id=c("Hour") ) # 把他們排成一排

write.csv(C0U600_tem_for_day_hr24_all, file="c://Taiwan-CWB-Data/writeCSV/C0D560_礁溪_tem_data_.csv")
...
names(C0U600_press_for_day_hr24)[2:lengthDatep] <- as.vector(as.factor(date))
C0U600_press_for_day_hr24_all <- melt(C0U600_press_for_day_hr24, id=c("Hour") ) # 把他們排成一排

write.csv(C0U600_press_for_day_hr24_all, file="c://Taiwan-CWB-Data/writeCSV/C0D560_礁溪_press_data_.csv")
