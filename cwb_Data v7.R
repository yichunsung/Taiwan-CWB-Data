...
getDataformCWB_Mon_ENG <- function(station, timerange, iterm){
  ...
  url_1 <- "http://e-service.cwb.gov.tw/HistoryDataQuery/MonthDataController.do?command=viewMain&station="
  url_2 <- "&stname=%25E7%25AB%25B9%25E6%259D%25B1&datepicker="
  url_1_1 <- paste(url_1, stationList$id, sep = "")
  url_all <- paste(url_1_1, url_2, sep = "")
  ...
  day31 <- data.frame(day=1:31) # set one day time
...
StationAllTable_engName_mon <- function(station, STmonth){
  station_Press <- getDataformCWB_Mon_ENG(station, STmonth, "Press")
  station_Hum <- getDataformCWB_Mon_ENG(station, STmonth, "Hum")
  station_Tem <- getDataformCWB_Mon_ENG(station, STmonth, "Tem")
  station_Rain <- getDataformCWB_Mon_ENG(station, STmonth, "Rain")
...
YMS <- StationAllTable_engName_mon("ZHUZIHU", "2017-05")
...
Zhudong <- StationAllTable("竹東", "2017-05-22", "2017-05-30")
Hutoupi <- StationAllTable_engName("Hutoupi", "2017-05-22", "2017-05-30")
JS <- StationAllTable("礁溪", "2017-05-22", "2017-05-30")
Beiliao <- StationAllTable("北寮", "2017-05-22", "2017-05-30")
FS <- StationAllTable("鳳山", "2017-05-22", "2017-05-30")
GS <- StationAllTable("金山", "2017-05-22", "2017-05-30")
