...
Zhudong <- StationAllTable("竹東", "2017-06-19", "2017-07-02")
Hutoupi <- StationAllTable_engName("Hutoupi", "2017-06-19", "2017-07-02")
JS <- StationAllTable("礁溪", "2017-06-19", "2017-07-02")
Beiliao <- StationAllTable("北寮", "2017-06-19", "2017-07-02")
FS <- StationAllTable("鳳山", "2017-06-19", "2017-07-02")
GS <- StationAllTable("金山", "2017-06-19", "2017-07-02")
YMS <- StationAllTable_engName("ZHUZIHU", "2017-06-19", "2017-07-02")
